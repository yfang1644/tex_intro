...
\begin{frame}[t]{How a Book is Published}
...
\begin{itemize}
    ...
    \item A book desinger, or an editor (of the company) chooses
        ...
        The editor needs knowledges both the author and the publishing.
    \item The typesetters typeset the book according to these instructions.
\end{itemize}

When you use WYSIWYG(What you see is what you get), you pretend you are
    three of them.\\[10pt]

When you use \TeX, you are just an author, \LaTeX is the editor,
\TeX is typesetters(you don't need to know them in most cases).

But \LaTeX is only a programm. You must give guidance, ie. Programming.
\end{frame}
...
DO NOT focus too much on {\em how the document looks like}.
...
\textbackslash setcounter{tocdepth}{2} will list sections in content
    until level 2.
\end{frame}
...
\begin{enumerate}
    ...
    \item Find relevant (first hand) sources as many as possible, positive
